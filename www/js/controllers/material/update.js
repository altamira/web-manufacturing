            ...
            Restangular.all('common').one('material', $scope.materialId).get().then(function(response) {
                ...
                switch ($scope.materialTypeText) {
                    case 'Product':
                        ...
                        $scope.material.width = response.data.width.formula;
                        $scope.material.widthType = response.data.width.unit.id;
                        $scope.material.height = response.data.height.formula;
                        $scope.material.heightType = response.data.height.unit.id;
                        $scope.material.length = response.data.length.formula;
                        $scope.material.lengthType = response.data.length.unit.id;
                        $scope.material.weight = response.data.weight.formula;
                        $scope.material.weightType = response.data.weight.unit.id;
                        $scope.material.depth = response.data.depth.formula;
                    ...
                    case 'Material':
                        ...
                        $scope.material.thickness = response.data.thickness.formula;
                ...
                if (isValid) {
                    ...
                    switch ($scope.materialTypeText) {
                        ...
                        case 'Material':
                            ...
                            $scope.postData.thickness.formula = $scope.material.thickness;
